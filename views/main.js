function submitBlog(event) {
    ...
    axios.post('http://localhost:3000/blog/add-blog', blogPost)
        .then(response => {
...
function fetchAndDisplayBlogs() {
    axios.get('http://localhost:3000/blog/get-blog')
        .then(response => {
...
function displayComments(blogId) {
    axios.get(`http://localhost:3000/comment/get-comment/${blogId}`)
        .then(response => {
...
function deleteComment(blogId, comment) {
    axios.delete(`http://localhost:3000/comment/delete-comment/${blogId}`, { data: { comment } })
        .then(response => {
...
function submitComment(blogId) {
    ...
    axios.post(`http://localhost:3000/comment/add-comment/${blogId}`, { comment })
        .then(response => {
         commentInput.value = '';
